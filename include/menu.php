...
<nav class="blue-grey darken-1">
    <div class="nav-wrapper">
        <a href="./" class="brand-logo center hide-on-large-only"><i class="material-icons md-36"></i> Arsip Surat</a>
        <ul id="slide-out" class="side-nav" data-simplebar-direction="vertical">
                    ...
                    <?php
                        ...
                        while($data = mysqli_fetch_array($query)){
                            ...
                            if(!empty($data['nama'])){
                                ...
                                echo '<h5 class="smk-side">Desa Sidowayah</h5>';
                            }
                            if(!empty($data['alamat'])){
                                echo '<p class="description-side">'.$data['alamat'].'</p>';
                            } else {
                                echo '<p class="description-side">Sidowayah, Polanharjo, Klaten, Jawa Tengah. </p>';
                            }
                        }
                    ?>
                </div>
            ...
            <li class="no-padding">
                <ul class="collapsible collapsible-accordion">
                    <li>
                        <a class="collapsible-header"><i class="material-icons">class</i> Referensi</a>
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="?page=ref">Surat Perintah Tugas</a></li>
                                <li><a href="?page=ref2">Laporan Hasil Perjalanan Dinas</a></li>
                                <li><a href="?page=ref3">Surat Perintah Perjalanan Dinas</a></li>
                            </ul>
                        </div>
                    </li>
                </ul>
        ...
        <ul class="center hide-on-med-and-down" id="nv">
            <li><a href="./" class="ams hide-on-med-and-down"><i class="material-icons md-36">mail</i> Arsip Surat</a></li>
            <li><div class="grs"></></li>
            ...
            <li><a class="dropdown-button" href="#!" data-activates="agenda">Galeri File <i class="material-icons md-18">arrow_drop_down</i></a></li>
                ...
                <li><a class="dropdown-button" href="#!" data-activates="referensi">Referensi <i class="material-icons md-18">arrow_drop_down</i></a></li>
                <ul id='referensi' class='dropdown-content'>
                                 <li><a href="?page=ref">Surat Perintah Tugas</a></li>
                                <li><a href="?page=ref2">Laporan Hasil Perjalanan Dinas</a></li>
                                <li><a href="?page=ref3">Surat Perintah Perjalanan Dinas</a></li>
                </ul>
